package com.fromzero.notificationservice.notifications.interfaces;
        ...
        public class NotificationController {
            ...
            public void sendEmailWithTemplate() throws IOException {
                ...
                Mail mail = new Mail();
                mail.setFrom(from);
                mail.setTemplateId("d-templateId"); // Reemplaza con tu Template ID
